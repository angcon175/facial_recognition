...
def TakeImages():
    ...
    if (is_number(Id) and name.isalpha()):
        ...
        harcascadePath = "I:\Courses\Anaconda\envs\pythonProject1\\haarcascade_frontalface_default.xml"
        ...
        with open('I:\\Courses\\Anaconda\\envs\\pythonProject1\\UserDetails.csv', 'a', newline='') as csvFile:
...
def TrainImages():
    ...
    faces, Id = getImagesAndLabels("I:\\Courses\\Anaconda\\envs\\pythonProject1\\TrainingImage")
    # Saving the trained faces and their respective ID's
    # in a model named as "trainner.yml".
    recognizer.train(faces, np.array(Id))
    recognizer.save("I:\\Courses\\Anaconda\\envs\\pythonProject1\\TrainingImageLabel\\Trainner.yml")
...
def TrackImages():
    ...
    recognizer.read("I:\\Courses\\Anaconda\\envs\\pythonProject1\\TrainingImageLabel\\Trainner.yml")
    harcascadePath = "I:\\Courses\\Anaconda\\envs\\pythonProject1\\haarcascade_frontalface_default.xml"
    faceCascade = cv2.CascadeClassifier(harcascadePath)
    # getting the name from "userdetails.csv"
    df = pd.read_csv("I:\\Courses\\Anaconda\\envs\\pythonProject1\\UserDetails.csv")
    cap = cv2.VideoCapture(0)
